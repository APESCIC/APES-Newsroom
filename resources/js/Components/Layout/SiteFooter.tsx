            ...
            <div className="mx-auto flex max-w-public flex-col gap-6 px-5 sm:px-6 md:flex-row md:items-start md:justify-between">
                ...
                <nav aria-label="Legal and subscriptions">
                    <ul className="flex flex-wrap gap-x-6 gap-y-3 text-sm text-muted">
                        ...
                        <li><Link href="/legal/cookies" className="inline-flex min-h-11 min-w-11 items-center justify-center hover:text-body">Cookies</Link></li>
                        <li><Link href="/legal/rights" className="inline-flex min-h-11 min-w-11 items-center justify-center hover:text-body">Your rights</Link></li>
                        <li><Link href="/mailing/signup" className="inline-flex min-h-11 min-w-11 items-center justify-center hover:text-body">Mailing lists</Link></li>
                    </ul>
                </nav>
            </div>
        </footer>
